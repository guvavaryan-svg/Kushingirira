...
// --- News Filter Inputs ---
input bool     UseNewsFilter     = false;  // Enable Native MT5 Calendar Filter
...
int OnInit()
{
   ...
   // Set 1-second timer for continuous tick-independent updates
   EventSetTimer(1);
   
   // Immediate First Dashboard Render
   DrawDashboard(); 
...
void OnDeinit(const int reason)
{
   ...
   Comment("====================================================\n" +
           "         EMA HYBRID v4.3 (STOPPED / REMOVED)       \n" +
           "====================================================\n" +
           " BOT STATUS : Offline. Expert Removed from Chart.   \n" +
           "====================================================\n");
...
//+------------------------------------------------------------------+
//| Timer function for smooth dashboard updates                      |
//+------------------------------------------------------------------+
void OnTimer()
{
   DrawDashboard();
...
//+------------------------------------------------------------------+
//| Chart Event function (Instant update on chart interaction)       |
//+------------------------------------------------------------------+
void OnChartEvent(const int id, const long &lparam, const double &dparam, const string &sparam)
{
   // Refresh Dashboard immediately on chart interaction
   DrawDashboard();
}
...
void OnTick()
{
   ...
   {
      currentStatus = "PAUSED: High Impact News Filter Active";
      DrawDashboard();
      return;
   }
...
//+------------------------------------------------------------------+
//| Fixed Basket Profit Target & Hard Loss Management                |
//+------------------------------------------------------------------+
...
void DrawDashboard()
{
   ...
   string dash = "====================================================\n";
   dash += "         EMA HYBRID v4.3 (REALTIME DASHBOARD)       \n";
   dash += "====================================================\n";
