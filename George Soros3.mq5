...
//| Version: 6.6 Deriv Protected & Enhanced                         |
//+------------------------------------------------------------------+
#property strict
...
input int    MaxSpreadPoints     = 150;       // Spread limit (Deriv Optimized)
...
int OnInit()
{
   ...
   Print("NEVER GIVE UP V6.6 DERIV SAFE - Symbol: ", _Symbol, " | Magic: ", MagicNumber);
