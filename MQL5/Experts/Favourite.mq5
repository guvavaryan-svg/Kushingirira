...
//| Version: 5.1 Dashboard Fixed                                    |
//+------------------------------------------------------------------+
#property strict
#include <Trade\Trade.mqh>
#include <ChartObjects\ChartObjectsBase.mqh>
...
int OnInit()
{
   ...
   Print("PRO BOT V5.1 READY - Symbol: ", _Symbol, " | Magic: ", MagicNumber);
...
//--- DASHBOARD GUI FUNCTIONS (Explicit Standard Enums) ---
void CreateDashboardLabel(string name, string text, int x, int y, color clr, int font_size = 9, bool is_bold = false)
{
   ...
   if(ObjectFind(0, obj_name) < 0)
   {
      ...
      ObjectSetInteger(0, obj_name, OBJPROP_CORNER, CORNER_TOP_RIGHT);
      ObjectSetInteger(0, obj_name, OBJPROP_ANCHOR, ANCHOR_TOP_RIGHT);
...
void CreateDashboardUI()
{
   ...
   if(ObjectFind(0, bg_name) < 0)
   {
      ...
      ObjectSetInteger(0, bg_name, OBJPROP_CORNER, CORNER_TOP_RIGHT);
      ObjectSetInteger(0, bg_name, OBJPROP_ANCHOR, ANCHOR_TOP_RIGHT);
