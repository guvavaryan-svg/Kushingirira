...
int OnInit()
{
   ...
   Print("PRO BOT V5.0 DASHBOARD READY - Symbol: ", _Symbol, " | Magic: ", MagicNumber);
...
void OnDeinit(const int reason)
{
   ...
   // Clean dashboard elements on removal
