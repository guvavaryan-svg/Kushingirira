...
//| Version: 11.6 APEX SCALPER FIX (PRO RELEASE)                     |
//+------------------------------------------------------------------+
#property strict
...
int OnInit()
{
   ...
   Print("APEX SCALPER V11.6 (FIXED EDITION) LOADED.");
...
void UpdateDashboard()
{
   ...
   CreateDashboardLabel("Title", "--- APEX SCALPER V11.6 ---", 25, 20, clrGold, 10, true);
...
bool IsHighImpactNewsNear()
{
   ...
   for(int i = 0; i < count; i++)
   {
      ...
      {
         // Gadziriswa: MQL5 Calendar Event uses currency_code
         if(event.currency_code == "EUR" || event.currency_code == "USD")
         {
